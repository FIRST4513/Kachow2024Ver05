package frc.robot.mechanisms.elevatorOld;
...
public class ElevFXMotorConfig {
     ...
     */
    public final double motionCruiseVelocity        = 100000; // 10 inches per second
    public final double motionAcceleration          = 65000; // 1 second to get up to cruise velocity
