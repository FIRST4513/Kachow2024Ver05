...
public class FieldConstants {
    ...
    public static final double BLUE_SPEAKER_LEFT_GYRO  = -120;
    public static final double BLUE_SPEAKER_CTR_GYRO   = -180;
    public static final double BLUE_SPEAKER_RIGHT_GYRO = 120;
    ...
    public static final double RED_SPEAKER_LEFT_GYRO  = -120;
    public static final double RED_SPEAKER_CTR_GYRO   = -180;
    public static final double RED_SPEAKER_RIGHT_GYRO = 120;
